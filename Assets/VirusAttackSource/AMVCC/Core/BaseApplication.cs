...
namespace VirusAttackSource.AMVCC {
    ...
    public class BaseApplication : Element {
        ...
        public Model model {
            get {
                return m_model = Assert<Model>(m_model);
            }
        }
        ...
        public View view {
            get {
                return m_view = Assert<View>(m_view);
            }
        }
        private View m_view;
        ...
        public Controller controller {
            get {
                return m_controller = Assert<Controller>(m_controller);
            }
        }
        ...
        /// </summary>
        private List<UnityEngine.AsyncOperation> m_async_loads {
            get {
                return __async_loads == null
        ...
        virtual protected void Start() {
            ...
            if (m_first_scene) {
                m_first_scene = false; OnLevelWasLoaded(levelId);
            }
